      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        ...
        {loading ? (
          ...
          <div className="text-center py-20 bg-white rounded-2xl border border-slate-100 shadow-sm">
            ...
            <p className="text-slate-500 font-medium">You have no bookings yet.</p>
            <a href="/guest/rooms" className="mt-4 inline-block px-5 py-2 bg-amber-500 text-white text-sm font-medium rounded-xl hover:bg-amber-600 transition-colors">
              Browse Rooms
            </a>
          </div>
        ) : (
